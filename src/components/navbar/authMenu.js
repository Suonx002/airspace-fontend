    ...
    <>
      ...
      {user.role === 'user' && (
        <>
          ...
          <Button
            ...
            onClick={() => {
              dispatch(modalActions.showBecomeHostModal());
            }}>
            Become a host
          </Button>
        </>
      ...
      <IconButton
        ...
        <div className={classes.avatarContent}>
          ...
          <Typography
            variant='body1'
            className={classes.profileName}>{`${capitalizeString(
            user.firstName
          )} ${capitalizeString(user.lastName)}`}</Typography>
          <Typography variant='body1' className={classes.profileArrow}>
            {isMenuClicked ? <ExpandLessIcon /> : <ExpandMoreIcon />}
          </Typography>
        </div>
      </IconButton>
      <Menu
        ...
        <MenuItem
          onClick={handleAvatarAnchorClose}
          className={classes.profileMenuItem}>
          <Typography variant='inherit' className={classes.profileMenuTitle}>
            Trips
          </Typography>
        </MenuItem>
        <MenuItem
