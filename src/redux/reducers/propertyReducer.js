...
const propertyReducer = (state = initialState, action) => {
  switch (action.type) {
    ...
    case types.GET_HOMEPAGE_PROPERTIES:
      return {
        ...state,
        homepageProperties: action.payload,
        isLoading: false,
        error: null,
      };
    ...
    case types.CREATE_PROPERTY:
      return {
        ...state,
        allProperties: [action.payload, ...state.allProperties],
        isLoading: false,
        error: null,
      };
    ...
    case types.CREATE_PROPERTY_REVIEW:
      return {
        ...
        property: {
          ...state.property,
          propertyReviews: [
            action.payload.propertyReview,
            ...state.property.propertyReviews,
          ],
        },
      };
    case types.UPDATE_PROPERTY_REVIEW:
      return {
        ...
        property: {
          ...state.property,
          propertyReviews: state.property.propertyReviews.map((review) =>
            review.id === action.payload.propertyReviewId
              ? action.payload.propertyReview
              : review
          ),
        },
    ...
    case types.DELETE_PROPERTY_REVIEW:
      return {
        ...
        property: {
          ...state.property,
          propertyReviews: state.property.propertyReviews.filter(
            (review) => review.id !== action.payload.propertyReviewId
          ),
        },
      };
    case types.GET_CURRENT_PROPERTY_REVIEW:
      return {
        ...state,
        currentPropertyReview: action.payload,
        isLoading: false,
        error: null,
      };
    case types.CLEAR_CURRENT_PROPERTY_REVIEW:
      return { ...state, currentPropertyReview: null };
